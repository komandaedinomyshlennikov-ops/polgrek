...
window.POL_GREK = {
  ...
  legal: {
    ...
    privacy:
      'Сайт не собирает персональные данные через собственные формы. Переходы на Литрес, Amazon и Threads регулируются политиками этих площадок.',
  },
  faq: [
    {
      q: 'Это не очередной биохакинг-развод?',
      a: 'Сайт и книги не продают добавки, курсы «станешь сверхчеловеком» и чудо-протоколы. Есть дисклеймеры, уровни доказательности [A]–[D] и явные разборы того, что не работает (включая хайп вроде «обязательных 2 литров воды»). Проверяйте: отрывок бесплатно → покупка на Литрес/Amazon, не «закрытый клуб».',
    },
    {
      q: 'Почему писал на русском, если родился в Англии?',
      a: 'Жена — Лора Грэк, русская, клинический психолог, МГУ. Пол начал учить русский в 35. Книги и Threads @pol.grek — на русском, потому что это язык семьи и аудитории, а не «перевод с английского ради рынка».',
    },
    {
      q: 'Кто отвечает за научную часть?',
      a: 'Тексты Пола опираются на peer-reviewed исследования (сон, стресс, нейропластичность, когнитивное долголетие) с указанием уровней доказательности. Лора — клинический психолог (КПТ, психоэндокринология), 12+ лет практики, соавтор части книг. Это научпоп, не клиническое руководство: решения о здоровье — с вашим врачом.',
    },
    {
      q: 'Где купить и как проверить, что автор настоящий?',
      a: 'Страница автора на Литрес: litres.ru/author/pol-grek/. Threads: @pol.grek. Amazon — по имени Пол Грэк / Pol Grek. Сайт — витрина и редакция, не собственный магазин: оплата идёт на площадках.',
    },
  ],
  methodExample: {
    title: 'Пример anti-hype, не абстракция',
    myth: '«Пейте 2 литра воды в день — иначе мозг не работает»',
    fact: 'Жёсткая цифра 2 л без учёта веса, климата и нагрузки — чаще маркетинг, чем физиология. База (сон, свет, движение, стресс) важнее ритуала «аквариума». Так же Пол разбирает БАДы: есть база уровня A–B — оставляем; остальное — «не покупайте догму».',
  },
  author: {
    name: 'Пол Грэк',
    nameEn: 'Pol Grek',
    threads: 'pol.grek',
    role: 'Исследователь прикладной нейропсихологии · автор научпопа',
    tagline: 'Без воды и эзотерики — только то, что реально работает и подтверждено исследованиями.',
    bioShort:
      'Образование: когнитивные науки + IT. 15+ лет консультировал IT и финансы по стрессу и когнитивной эффективности. На пике сам выгорел — вернулся к исследованиям, не к гуру. Книги на Литрес; живой разговор — Threads @pol.grek.',
    education:
      'Образование в области когнитивных наук (cognitive science) и IT-бэкграунд: связка «как устроен мозг» + «как устроены цифровые/организационные системы, в которых люди сгорают».',
    practice:
      'Практика: консультации для международных IT-компаний и финансовых организаций — устойчивость к стрессу, когнитивная эффективность, режимы высокой нагрузки (дедлайны, смены контекста, KPI без осязаемого финала). Не «коучинг успеха», а прикладная нейропсихология на стыке науки и работы команд.',
    publications:
      'Публичная апробация: серия научпоп-книг на Литрес (в т.ч. «Мозг на 100+», «Биохакинг мозга», «RESET», «Стресс и мозг», «Анатомия энергии», совместные с Лорой — «Женский мозг», «Мужской мозг», «ЭИ 2.0»). В книгах — ссылки на исследования и уровни доказательности [A]–[D], не «мне кажется».',
    burnoutStory:
      'На пике карьеры: бессонница, туман в голове, ноль мотивации — при «нормальной» жизни снаружи. Отдых выходными не помогал. Не пошёл к гуру продуктивности: перечитал работы по сну, нейропластичности, метаболизму мозга, аллостазу. Вернулся к базе (свет, сон, движение, границы нагрузки). Из этого выросли протоколы и книги — сначала чтобы снова соображать, потом чтобы поделиться.',
    birth: 'Англия',
    russianFromAge: 35,
    principles: [
      {
        title: 'Не стыдит — объясняет',
        text: '«Не слетела». «Это не зумер и не каприз». Сначала снимает ярлык, потом даёт механизм. Так и строится доверие.',
      },
      {
        title: 'Механика простым языком',
        text: 'Дофамин, кортизол, входящий поток — всегда с бытовым переводом: «мозг плохо получает дофамин от KPI без видимого результата».',
      },
      {
        title: 'Один следующий шаг',
        text: 'Не «измени жизнь». Один конкретный шаг, 15 минут без ленты, 3 дня тишины вместо мифических 30.',
      },
      {
        title: 'Личный прогон + анти-хайп',
        text: '«2 л — маркетинг, а не физиология». «Писал из собственного опыта». Без позитивного мышления — с разбором.',
      },
    ],
    voiceCode: {
    ...
    autobiography: [
      {
        checkpoint: '1. Образование: когнитивные науки + IT',
        text: 'База — cognitive science (как устроено мышление, внимание, память) и IT. Эта связка объясняет, почему книги Пола не «эзотерика про энергию», а протоколы с механизмами: дофамин, кортизол, циклы сна, когнитивный резерв.',
      },
      {
        checkpoint: '2. Практика 15+ лет: IT и финансы',
        text: 'Консультировал международные IT-компании и финансовые организации: устойчивость к стрессу, когнитивная эффективность, работа в режиме вечных дедлайнов. «Команды» — продуктовые, engineering и high-load контуры, где люди формально «успешны», а сон и фокус уже нет.',
      },
      {
        checkpoint: '3. Личное выгорание — не слоган',
        text: 'На пике: бессонница, brain fog, ноль мотивации. Выходные «просто отдохни» не помогали. Не пошёл к гуру: вернулся к исследованиям (сон, нейропластичность, аллостаз). Собрал то, что реально вернуло ясность — и только потом оформил в книги.',
      },
      {
        checkpoint: '4. Апробация: книги и evidence [A]–[D]',
        text: 'Публичный результат — серия на Литрес (профиль litres.ru/author/pol-grek/): когнитивное долголетие, биохакинг без вреда, RESET/выгорание, стресс, энергия, деньги; с Лорой — женский/мужской мозг и эмоциональный интеллект. В книгах — уровни доказательности и «что не покупать».',
      },
      {
        checkpoint: '5. Лора Грэк (МГУ) · русский с 35',
        text: 'Соавтор и клинический психолог: КПТ, психоэндокринология, 12+ лет с женщинами в перименопаузе. Выпускница МГУ. Пол учил русский с 35 — ради семьи и общего языка. Совместные книги — два голоса: лаборатория + кабинет.',
      },
      {
        checkpoint: '6. Живой канал · Threads @pol.grek',
        text: 'Июнь 2026: пост о полке на Литрес — «сначала чтобы починить себя, потом чтобы поделиться». Профиль: threads.net/@pol.grek. Тот же код: не стыдить → механика → один шаг → мягкий CTA к книге.',
      },
    ],
    threadsQuote: {
  ...
  laura: {
    name: 'Лора Грэк',
    role: 'Клинический психолог · выпускница МГУ',
    bio: 'Русская, окончила МГУ. Специалист по КПТ и психоэндокринологии. Более 12 лет работает с женщинами в перименопаузе: мозговой туман, тревога, перепады настроения. Соавтор научных статей о влиянии гормонов на когнитивные функции. В книгах — голос кабинета рядом с лабораторией Пола.',
  },
  ...
  books: [
    ...
    },
    {
      ...
      tags: ['энергия', 'стресс'],
      promise: 'Митохондрии, когнитивная нагрузка, циркадные ритмы — без $200 стека добавок.',
      annotation:
    ...
    },
    {
      ...
      series: 'Серия «Мозг»',
      tags: ['деньги'],
      promise: 'Не сила воли — архитектура выбора. Дофамин, страх потерь, автоматика.',
      annotation:
    ...
    },
    {
      ...
      promise: 'Стресс — не враг. Это инструмент, которым нужно уметь пользоваться.',
      annotation:
    ...
    },
    {
      ...
      promise: 'Не «думай позитивно» — почему отдых не помогает и с чего реально начинать.',
      annotation:
    ...
    },
    {
      ...
      series: 'Серия «Мозг»',
      tags: ['биохакинг'],
      promise: 'Осторожность вместо гонки за стеками. 2 литра воды — иногда просто маркетинг.',
      annotation:
    ...
    },
    {
      ...
      promise: 'Не «стать молодым снова» — вернуть взрослые силу, фокус и характер.',
      annotation:
  ...
  articles: [
    ...
    },
    {
      ...
      title: '«Заебалась» и выгорание — одна физиология',
      category: 'Стресс и выгорание',
      hook: 'Честнее не скажешь. Ощущение и механизм — разные слова для одной остановки на красный.',
      readMin: 7,
      relatedBook: 'reset',
  ...
  filters: [
    ...
    { id: 'гормоны', label: 'Гормоны & пол', match: (b) => b.tags.includes('гормоны') },
