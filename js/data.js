...
window.POL_GREK = {
  ...
  socialProof: {
    ...
    note: 'Оценки с страницы автора на Литрес. Без выдуманных отзывов — только то, что видно на площадке.',
  },
  author: {
    name: 'Пол Грэк',
    nameEn: 'Pol Grek',
    ...
    bioShort:
      'Родился в Англии. Когнитивные науки + IT. 15+ лет на стыке нейробиологии, технологий и команд. В 35 начал учить русский — ради жены Лоры, выпускницы МГУ. Сам прошёл выгорание: разобрал мозг по запчастям и собрал обратно. Книги — на Литрес и Amazon.',
    birth: 'Англия',
    russianFromAge: 35,
    principles: [
      {
    ...
    autobiography: [
      {
        checkpoint: 'Англия · начало',
        text: 'Пол Грэк родился в Англии. С детства привык к культуре, где ценят ясную мысль, сдержанный юмор и недоверие к громким обещаниям — это до сих пор слышно в его текстах: без пафоса, без «раскрой потенциал», с уважением к читателю.',
      },
      {
        checkpoint: 'Когнитивные науки + IT',
        text: 'Образование в когнитивных науках и IT-бэкграунд сложились в редкую связку: он понимает и устройство мозга, и устройство систем, в которых люди сгорают — дедлайны, KPI, бесконечные «динамики» без осязаемого финала.',
      },
      {
        checkpoint: '15+ лет на стыке науки и команд',
        text: 'Консультировал международные IT-компании и финансовые организации по устойчивости к стрессу и когнитивной эффективности. Видел изнутри, как умные, дисциплинированные люди теряют сон, фокус и смысл — при «нормальной» жизни снаружи.',
      },
      {
        checkpoint: 'Личное выгорание',
        text: 'На пике карьеры выгорел сам: бессонница, туман, ноль мотивации. Не ушёл к гуру продуктивности. Вернулся к исследованиям — сон, нейропластичность, метаболизм мозга, аллостаз. «Разобрал свой мозг по запчастям и собрал обратно» — не метафора для обложки, а рабочая биография автора.',
      },
      {
        checkpoint: 'Лора · русский язык с 35 лет',
        text: 'Жена — Лора Грэк, русская, клинический психолог, выпускница МГУ. Ради семьи и общего языка Пол в 35 лет начал учить русский. Сегодня он пишет на русском так, как говорят живые люди в комментариях Threads — коротко, по делу, без канцелярита. Это не «перевод с английского». Это второй дом для смысла.',
      },
      {
        checkpoint: 'Два голоса в книгах',
        text: 'Часть книг — совместные с Лорой: лаборатория (механизмы, рецепторы, evidence) + кабинет (что люди реально говорят, что помогает, что ранит). «Женский мозг», «Мужской мозг», «Эмоциональный интеллект 2.0» — разговор, а не монолог теоретика.',
      },
      {
        checkpoint: 'Книги на Литрес · 2026',
        text: 'В июне 2026 Пол собрал на Литрес то, что собирал годами: сон, мозг, выгорание, биохакинг, деньги. «Сначала чтобы починить себя, потом — чтобы поделиться». Без воды и эзотерики. Продолжает тот же разговор в Threads @pol.grek — простым языком, без занудства.',
      },
    ],
  },
