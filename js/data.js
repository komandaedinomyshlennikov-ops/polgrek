...
window.POL_GREK = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Главная проверяемая точка — страница автора на Литрес: litres.ru/author/pol-grek/ (книги, описания, оценки). На сайте — 13 ключевых книг; полный каталог изданий — на Литрес. Сайт — витрина и редакция, не магазин: оплата на площадке. Соцсети — дополнительный канал, не единственное доказательство.',
    },
  ],
  methodExample: {
  ...
  author: {
    ...
    publications:
      'Книги на Литрес — от «RESET» о выгорании до «Мозга на 100+» и «Мозга и денег». На сайте — 13 ключевых; полный каталог — на странице автора. В работе — уровни доказательности A–D.',
    burnoutStory:
