...
window.POL_GREK = {
 ...
 privacy:
 'Отрывок скачивается без email. Почта — только с согласия (чекбокс): ссылка на главу и редкие письма (не чаще раза в месяц), FormSubmit → hello@polgrek.site, не передаём третьим лицам. Метрика 110711984. Подробнее: privacy.html.',
 },
 faq: [
 {
 ...
 'Самопроверка и короткие эксперименты',
 ...
 pullQuote: "Усталость снимается отдыхом. Выгорание — нет. Можно проспать выходные и проснуться таким же.",
 authors: ['Пол Грэк'],
 cover: 'cover-6',
 series: 'Восстановление',
 tags: ['выгорание', 'стресс'],
 promise: 'Усталость снимается отдыхом. Выгорание — нет. С чего реально начинать.',
 annotation:
