...
window.POL_GREK = {
 ...
 faq: [
 {
 q: 'Чем это отличается от обычного биохакинга в интернете?',
 a: 'Здесь нет курсов «станешь сверхчеловеком» и чудо-протоколов. В книгах важные утверждения помечаются уровнями доказательности A–D — где данные крепче, а где нужна осторожность. Хайп (в том числе жёсткие «обязательные 2 литра воды») разбирается прямо в тексте. Отрывок можно прочитать бесплатно, покупка — на Литрес, открытой площадке, а не в «закрытом клубе».',
 },
 {
 q: 'Почему книги на русском, если автор из Англии?',
 a: 'Жена Пола — Лора Грэк, клинический психолог, выпускница МГУ. Русский он начал учить с 35 лет, чтобы говорить с семьёй на одном языке. Книги и короткие посты — на русском для той же аудитории, а не «перевод ради рынка». Пишет коротко и по делу, без лишней воды.',
 },
 {
 q: 'Насколько это научно — и кто за это отвечает?',
 a: 'Тексты Пола — научпоп о мозге: где можно, стоят уровни A–D, без обещания «всё уже доказано». Лора — клинический психолог, соавтор части книг (тревога, гормоны, эмоциональный интеллект). Это не медицинское руководство: решения о здоровье лучше принимать с вашим врачом. Книги, описания и оценки читателей — на странице автора на Литрес.',
 },
 {
 q: 'Где купить книги и как убедиться, что автор настоящий?',
 a: 'Проще всего открыть профиль на Литрес: litres.ru/author/pol-grek/ — там книги, описания, оценки и отзывы. На этом сайте — 13 книг с отрывками; оплата только на Литрес, мы сами платежи не принимаем. Ещё можно заглянуть в Telegram и Threads @pol.grek — живые каналы, не вместо Литрес, а рядом.',
 },
 ],
 methodExample: {
 ...
 text: 'Изучает, как устроены внимание, сон, стресс и привычки. Книги — не эзотерика и не «стань сверхчеловеком», а понятные протоколы с честной оценкой: что опирается на данные (уровни A–D), а что пока гипотеза.',
 },
 {
 checkpoint: '2. Работа с людьми под сильной нагрузкой',
 text: 'Консультирует команды и специалистов из IT, финансов и других сфер, где снаружи «всё успешно», а внутри — туман в голове, бессонница и постоянный стресс. Помогает выстроить устойчивость, а не геройствовать до выгорания.',
 },
 {
 checkpoint: '3. Своё выгорание — не красивый слоган',
 text: 'Сам прошёл истощение: выходные и совет «просто отдохни» не возвращали ясность. Сначала разобрался, что реально помогает, — потом собрал это в научпоп для читателей.',
 },
 {
 checkpoint: '4. Книги на Литрес — можно проверить',
 text: 'Открытая полка на Литрес: мозг и долголетие, осторожный биохакинг, RESET и выгорание, стресс, энергия, деньги. С Лорой — женский и мужской мозг, эмоциональный интеллект. Описания, оценки и отзывы — на площадке, не «наш закрытый клуб».',
 },
 {
 checkpoint: '5. Семья, русский язык и живой канал',
 text: 'Соавтор — Лора Грэк, клинический психолог, выпускница МГУ. Русский начал учить с 35 лет, чтобы говорить с семьёй на одном языке. В Threads @pol.grek — короткие разборы: без стыда, с механизмом и одним шагом; к книге — только если это уместно.',
 },
 ],
 threadsQuote: {
 ...
 promise: 'Протокол когнитивного долголетия — с оценкой надёжности каждого совета.',
 annotation:
 ...
 promise: 'Честный гид: что реально работает — база и минимальная эффективная доза, без «волшебных» таблеток.',
 annotation:
 ...
 genre: 'Научпоп',
 evidenceGrades: true,
 researchNote: 'Уровни доказательности A–D · протокол после истощения',
 title: 'RESET',
