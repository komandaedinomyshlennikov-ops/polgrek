...
window.POL_GREK = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Жена — Лора Грэк, клинический психолог, МГУ. Русский язык Пол начал учить с 35 лет — ради семьи и общего языка. Книги, Telegram @polgrekauthor и Threads @pol.grek — на русском: язык семьи и аудитории, не «перевод ради рынка». Стиль намеренно короткий — меньше когнитивной нагрузки.',
    },
    {
