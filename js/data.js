...
window.POL_GREK = {
  ...
  author: {
    ...
    bioShort:
      'Родился в Англии. Когнитивные науки на стыке с IT, 15+ лет — нейробиология, технологии и команды: консультации IT и финансов по стрессу и когнитивной эффективности. Русский — с 35, благодаря жене Лоре (МГУ, клинический психолог). Сам прошёл выгорание — и только потом писал книги.',
    bioFull: [
      'Пол Грэк родился в Англии. Изучает когнитивные науки на стыке с IT и уже больше 15 лет работает на пересечении нейробиологии, технологий и управления командами — консультирует международные IT-компании и финансовые организации по вопросам устойчивости к стрессу и когнитивной эффективности.',
      'В 35 лет начал учить русский язык — во многом благодаря жене, Лоре Грэк, выпускнице МГУ и клиническому психологу. Сегодня Пол пишет на русском так же, как отвечает читателям в Threads: коротко, по делу, без давления.',
      'Прежде чем писать о выгорании, стрессе и когнитивном здоровье, Пол сам прошёл через выгорание — и именно это стало отправной точкой для его книг: сначала он разбирался, что помогает лично ему, и только потом превращал это в системный, проверяемый материал для читателей.',
    ],
    education:
      'Когнитивные науки на стыке с IT — связка «как устроен мозг» и «как устроены системы, в которых люди сгорают».',
    practice:
      'Больше 15 лет на пересечении нейробиологии, технологий и управления командами. Консультирует международные IT-компании и финансовые организации: устойчивость к стрессу и когнитивная эффективность.',
    publications:
      'Книги на Литрес и Amazon — от «RESET» о выгорании до «Мозга на 100+» и «Мозга и денег». В работе — уровни доказательности A–D.',
    burnoutStory:
      'Прежде чем писать о выгорании, стрессе и когнитивном здоровье, Пол сам прошёл через выгорание. Сначала разбирался, что помогает лично ему, — и только потом превращал это в системный, проверяемый материал для читателей.',
    birth: 'Англия',
    russianFromAge: 35,
    principles: [
      {
  ...
  laura: {
    ...
    bio: 'Соавтором нескольких тем выступает Лора Грэк — она отвечает за клинический голос книг, основанный на её практике: перименопауза, тревога и то, с чем реально приходят люди на приём.',
  },
