...
window.POL_GREK = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Главная проверяемая точка — страница автора на Литрес: litres.ru/author/pol-grek/ (книги, описания, оценки). На Amazon — по имени Пол Грэк / Pol Grek. Сайт — витрина и редакция, не магазин: оплата только на площадках. Соцсети — дополнительный канал, не единственное доказательство.',
    },
  ],
  methodExample: {
