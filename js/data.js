...
window.POL_GREK = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Тексты Пола опираются на научные исследования (сон, стресс, нейропластичность, когнитивное долголетие) с указанием уровней доказательности. Лора — клинический психолог (КПТ, психоэндокринология), 12+ лет практики, соавтор части книг. Это научпоп, не клиническое руководство: решения о здоровье — с вашим врачом.',
    },
    {
  ...
  author: {
    ...
    bioFull: [
      'Пол Грэк родился в Англии. Получил образование в области когнитивных наук и уже больше 15 лет работает на пересечении нейробиологии, технологий и управления командами — консультирует международные IT-компании и финансовые организации по вопросам устойчивости к стрессу и когнитивной эффективности.',
      'В 35 лет начал учить русский язык — во многом благодаря жене, Лоре Грэк, выпускнице МГУ и клиническому психологу. Сегодня Пол пишет на русском коротко, по делу, без давления.',
