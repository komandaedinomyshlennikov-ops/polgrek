...
window.POL_GREK = {
  ...
  legal: {
    ...
    privacy:
      'Сайт не собирает персональные данные через собственные формы. Переходы на Литрес и внешние площадки регулируются политиками этих сервисов.',
  },
  faq: [
    {
    ...
    },
    {
      ...
      a: 'Жена — Лора Грэк (Соколова), клинический психолог, аспирантура МГУ. Пол начал русский в 35 (1998) — ради семьи и чтения Лурии/Выготского. Книги и Threads @pol.grek — на русском: язык семьи и аудитории, не «перевод ради рынка». Стиль намеренно короткий — меньше когнитивной нагрузки.',
    },
    {
      q: 'Кто отвечает за научную часть?',
      a: 'База Пола — Оксфорд/Кембридж и прикладная нейропсихология 35+ лет; в книгах — уровни доказательности A–D. Лора — клинический психолог, соавтор части книг (тревога, гормоны, ЭИ). Это научпоп, не клиническое руководство: решения о здоровье — с вашим врачом.',
    },
    {
  ...
  author: {
    ...
    nameEn: 'Pol Grek',
    threads: 'pol.grek',
    role: 'Прикладная нейропсихология · основатель Grek Resilience Labs · автор научпопа',
    tagline: 'Без воды и эзотерики — только то, что реально работает и подтверждено исследованиями.',
    bioShort:
      'Родился в послевоенной Англии. Оксфорд и Кембридж (экспериментальная психология, когнитивные науки), затем 35+ лет на стыке нейробиологии, IT и команд. Русский — с 35, благодаря жене Лоре (МГУ, клинический психолог). Личное выгорание в 2016 — отправная точка книг.',
    bioFull: [
      'Пол родился в послевоенной Англии в семье университетского преподавателя классической филологии и школьной учительницы биологии. Атмосфера оксфордских библиотек и лабораторий определила его путь с ранних лет.',
      'Бакалавриат (1981–1985): Оксфорд, Колледж Святого Иоанна — экспериментальная психология с уклоном в физиологию. Магистратура (1985–1987): Кембридж, Кингс-Колледж — когнитивные науки; диссертация о нейронных механизмах рабочей памяти в многозадачности. Стажировка (1987–1989): Институт нейробиологии Макса Планка (Мюнхен) — первый серьёзный поворот к прикладному применению мозговых исследований.',
      'С конца 1980-х — Лондон: стресс и когнитивные функции у авиадиспетчеров; 1990-е — 2000-е: нейрофизиологические тесты для пилотов и диспетчеров в оборонных и аэрокосмических проектах; 2005–2012: направление «Человеческий фактор и устойчивость» в крупном международном консалтинге (Лондон). С 2012 — собственное бюро Grek Resilience Labs (биометрия, VR, ML для стрессоустойчивости команд). Более 35 лет на стыке нейробиологии, IT и управления людьми; последние 20 — интенсивно как консультант.',
      'В 1998 в Берлине познакомился с Лорой (в девичестве Соколовой), клиническим психологом после аспирантуры МГУ. Женились в 2000. В 35 лет (1998) начал русский — ради семьи и советской нейрофизиологии (Лурия, Выготский). Двое взрослых детей: Алекс (2002, биоинформатика) и Анна (2005, клинический психолог).',
      'В 2016, в 53 года, после сверхнагруженных проектов — тяжёлое профессиональное выгорание. Лора настояла на трёхмесячном перерыве. До 2016 — академические статьи и корпоративные отчёты; после — дневник восстановления и научпоп-книги для широкой аудитории.',
    ],
    education:
      'Оксфорд (экспериментальная психология, 1981–1985), Кембридж (когнитивные науки, 1985–1987), стажировка Max Planck (Мюнхен, 1987–1989). Практика с конца 1980-х — на стыке нейробиологии, IT и высоких нагрузок, а не «второе образование IT» в дипломе.',
    practice:
      '35+ лет на стыке нейробиологии, IT и управления людьми (около 20 лет — интенсивно как консультант): авиация и оборона, корпоративный human factor, с 2012 — Grek Resilience Labs. Клиенты — банки, tech, high-load команды.',
    publications:
      'Книги на Литрес — от «RESET» о выгорании до «Мозга на 100+» и «Мозга и денег». На сайте — 12 ключевых; полный каталог — на странице автора. В работе — уровни доказательности A–D. До 2016 — в основном академика и корпоративные отчёты.',
    burnoutStory:
      '2016, 53 года: после круглосуточных проектов для финансовой биржи — истощение, бессонница, провал продуктивности. Лора, как клинический психолог, настояла на трёхмесячном перерыве без экранов. Этот кризис стал катализатором научпопа: сначала дневник восстановления, потом книги.',
    birth: 'Англия (послевоенное поколение; ~1963 по хронологии: 35 лет в 1998, 53 в 2016)',
    russianFromAge: 35,
    principles: [
      {
    ...
    autobiography: [
      {
        checkpoint: '1. Образование: Оксфорд → Кембридж → Max Planck',
        text: 'Экспериментальная психология (Оксфорд, 1981–1985), когнитивные науки (Кембридж, 1985–1987), стажировка в Институте нейробиологии Макса Планка (Мюнхен, 1987–1989). Отсюда связка «как устроен мозг» + «как это применять вне академии» — не эзотерика, а протоколы с механизмами.',
      },
      {
        checkpoint: '2. Практика 35+ лет: от авиации к консалтингу',
        text: 'Конец 1980-х: стресс у авиадиспетчеров. 1990-е–2000-е: нейротесты для пилотов и диспетчеров. 2005–2012: human factor в крупном международном консалтинге (Лондон) — банки, трейдеры, tech. С 2012: Grek Resilience Labs. Около 20 лет — интенсивно как консультант команд под нагрузкой.',
      },
      {
        checkpoint: '3. Лора, русский с 35, семья',
        text: 'Знакомство с Лорой (Соколовой) в 1998 в Берлине; брак в 2000. Русский — с 35 (1998): семья и первоисточники (Лурия, Выготский). Стиль речи — коротко, с минимальной когнитивной нагрузкой. Дети: Алекс (2002, биоинформатика), Анна (2005, клинический психолог).',
      },
      {
        checkpoint: '4. Выгорание 2016 — не слоган',
        text: 'В 53 года, после сверхнагруженных проектов: бессонница, падение продуктивности, «забыл дорогу до офиса». Лора настояла на трёхмесячном перерыве. До 2016 — академика и отчёты; после — дневник восстановления и научпоп.',
      },
      {
        checkpoint: '5. Апробация: книги и evidence [A]–[D]',
        text: 'Серия на Литрес (litres.ru/author/pol-grek/): когнитивное долголетие, биохакинг без вреда, RESET/выгорание, стресс, энергия, деньги; с Лорой — женский/мужской мозг и ЭИ. В книгах — уровни доказательности и «что не покупать».',
      },
      {
        checkpoint: '6. Живой канал · Threads @pol.grek',
        text: 'Июнь 2026: пост о полке на Литрес — «сначала чтобы починить себя, потом чтобы поделиться». Тот же код: не стыдить → механика → один шаг → мягкий CTA к книге.',
      },
    ],
    threadsQuote: {
  ...
  laura: {
    name: 'Лора Грэк',
    maidenName: 'Соколова',
    role: 'Клинический психолог · аспирантура МГУ · соавтор',
    bio: 'Лора Грэк (в девичестве Соколова) — клинический психолог, аспирантура МГУ им. М. В. Ломоносова. С Полом с 1998 (Берлин); брак с 2000. Клинический голос книг: тревога, перименопауза, выгорание — то, с чем люди приходят на приём. В 2016 настояла на перерыве Пола после его выгорания.',
  },
