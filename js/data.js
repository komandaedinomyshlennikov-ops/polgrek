...
window.POL_GREK = {
  ...
  author: {
    ...
    bioShort:
      'Родился в Англии. Пишет научпоп о мозге без эзотерики — на стыке нейропсихологии, технологий и работы с командами. Русский язык выучил с тридцати пяти лет, во многом благодаря жене Лоре, клиническому психологу и выпускнице МГУ. Сам прошёл через выгорание и только после этого начал писать книги. Проверяемая витрина — Литрес.',
    bioFull: [
      ...
      'В тридцать пять лет начал учить русский — во многом благодаря жене, Лоре Грэк, клиническому психологу и выпускнице МГУ. Сегодня пишет по-русски коротко и по делу.',
