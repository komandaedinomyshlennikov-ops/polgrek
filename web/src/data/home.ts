...
export const HOME = {
  ru: {
    hero: {
      ...
      lead: "Пол Грэк — научно-популярные книги и разборы о мозге, стрессе, энергии, сне и когнитивном долголетии. Без эзотерики, биохакинг-хайпа и советов «просто возьмите себя в руки».",
      ...
      familiar: "Знакомо?",
      why: "Большинство людей думают, что проблема в дисциплине. Но чаще так выглядит перегруженная нервная система: мозг не саботирует вас. Он адаптируется.",
      ctaNav: "Найти свою проблему",
      ctaRead: "Читать бесплатный фрагмент",
      proof: "Книги и разборы о мозге, стрессе, сне и энергии — для читателей России и СНГ.",
      sign: "Пол Грэк",
    ...
    recognize: {
      ...
      items: [
        ...
        },
        {
          ...
          body: "Это не отдых. Когда ресурс заканчивается, мозг чаще выбирает быстрый, лёгкий стимул — ленту, а не трудное дело. Это не «гормон удовольствия», который нужно детоксить.",
        },
        {
    ...
    author: {
      ...
      p1: "Автор научно-популярных книг о мозге, стрессе, сне, энергии, когнитивном долголетии и поведении.",
      p2: "Пишу для тех, кто хочет не просто получить очередной совет из интернета, а понять, что происходит с ним самим.",
      p3: "Я разбираю то, что происходит с вами, и отделяю науку от красивых объяснений.",
      p4: "Каждая книга начинается с уважения к читателю. Поведение почти всегда имеет биологическую причину раньше, чем моральную.",
