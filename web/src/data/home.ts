...
export const HOME = {
  ru: {
    ...
    recognize: {
      ...
      title: "Не ищите диагноз. Просто посмотрите, насколько это похоже на ваши дни.",
      items: [
        {
      ...
      items: [
        {
          slug: "mozg-na-100",
          tag: "Память · Внимание",
          forWhom: "Если после сорока ловите себя на мысли: «раньше так не было».",
          body: "Память меняется не потому, что вы «сдали». В книге — что на это влияет на самом деле и чем банки «для мозга» обычно не являются.",
          store: "litres" as const,
        },
        {
          slug: "anatomiya-energii",
          tag: "Энергия",
          forWhom: "Если всё делаете «правильно» — и к обеду уже нет сил.",
          body: "Энергию держат три вещи: сон, сколько мозг уже наработал за день, и как тело производит силы. Чинить одну и не смотреть на остальные — кофе не спасёт.",
          store: "amazon" as const,
        },
        {
          slug: "mentalnyy-debag",
          tag: "Фокус",
          forWhom: "Если важное откладывается, а лента открывается сама.",
          body: "Не ещё одна книга про продуктивность. Почему мозг уходит в мелочи — и что можно сделать сегодня, не устраивая себе выговор.",
          store: "litres" as const,
        },
      ],
    },
    ...
    lab: {
      ...
      items: [
        ...
        },
        {
          href: "/lab/#myths",
          title: "Разборы мифов",
          body: "«Два литра воды», «лень в 15:00», «Telegram убивает дофамин» — что из этого наука, а что слоган.",
        },
      ],
    },
    social: {
    ...
    cta: {
      title: "Начните не с самой известной книги. Начните с той, которая про ваши дни.",
